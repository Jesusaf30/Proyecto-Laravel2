                ...
                <div class="row">
                        ...
                        <select class="form-select @error('medicine_id') is-invalid @enderror" 
                            ...
                            @foreach($medicines as $medicine)
                                <option value="{{ $medicine->id }}" 
                                        {{ old('medicine_id', $stockEntry->medicine_id) == $medicine->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="unit_price" 
                                   name="unit_price" 
                                   value="{{ old('unit_price', $stockEntry->unit_price) }}" 
                                   step="0.01" 
                                   min="0" 
                                   required>
                            @error('unit_price')
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="invoice_number" 
                               name="invoice_number" 
                               value="{{ old('invoice_number', $stockEntry->invoice_number) }}" 
                               required>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                  id="notes" 
                                  name="notes" 
                                  rows="3">{{ old('notes', $stockEntry->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
